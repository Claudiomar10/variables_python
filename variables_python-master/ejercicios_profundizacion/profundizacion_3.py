...
#nombre con primera letra en mayusculas
nombre_capitalize = nombre_completo.capitalize()

#Salidas
print ("Tu nombre en minusculas es: ",nombre_lower,)
print ("Tu nombre en mayusculas es: ", nombre_upper)
print ("Tu nombre con la primera letra mayuscula es: ",nombre_capitalize)
