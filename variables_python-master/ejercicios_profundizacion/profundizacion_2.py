...
identificacion = int(input("Ingrese su Número de identificacion: "))
edad = int(input("Ingrese su edad: "))
altura = float(input("Ingrese su altura: "))

#Salidas
print ("Su nombre completo y su número de identificación es: ",nombre_completo," ", identificacion)
print ("Su Edad y su altura son: ",edad,altura)