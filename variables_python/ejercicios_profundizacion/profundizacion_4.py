...
# va a funcionar con un nombre y un apellidos
padre_1 = input ("Ingrese el nombre del padre: ")
madre_1 = input ("Ingrese el nombre del madre: ")
hijo_1 = input ("Ingrese solo nombre hijo (no apellido): ")

nombre_padre1,apellido_padre1 = padre_1.split()
nombre_madre1,apellido_madre1 = madre_1.split()

#concatenamos el nombre del hijo y los apellidos de los padres

nombre_completo = hijo_1 + " " + apellido_padre1 + " " + apellido_madre1
nombre_completo1 = nombre_completo.title()   #nos aseguramos que caca nombre comience con mayuscula sin importar como fue ingresado

print (" El nombre completo del hijo es:",nombre_completo1)
